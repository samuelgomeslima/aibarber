...
create index if not exists cash_register_entries_barbershop_idx
  on public.cash_register_entries (barbershop_id, created_at desc);
...
for select using (
  ...
  and exists (
    ...
    where staff.auth_user_id = auth.uid()
      and staff.barbershop_id = cash_register_entries.barbershop_id
  )
);
