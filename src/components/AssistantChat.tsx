...
const API_KEY_WARNING_MESSAGE = "Set EXPO_PUBLIC_ASSISTANT_API_TOKEN to enable the assistant.";
...
export default function AssistantChat({ colors, systemPrompt, contextSummary, onBookingsMutated, services }: AssistantChatProps) {
  ...
  const startVoiceRecording = useCallback(async () => {
    if (!isOpenAiConfigured) {
      setError("Set EXPO_PUBLIC_ASSISTANT_API_TOKEN to enable voice input.");
      return;
    }
