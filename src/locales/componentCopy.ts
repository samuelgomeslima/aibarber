...
export const COMPONENT_COPY: Record<SupportedLanguage, ComponentCopy> = {
  en: {
    ...
    servicePackageForm: {
      ...
      createSubtitle: "Bundle multiple services with a discounted price.",
      editSubtitle: "Update the name, included services, or pricing for this package.",
      fields: {
        nameLabel: "Name",
        namePlaceholder: "10 haircuts & shaves",
        nameError: "Name is required",
        priceLabel: "Package price",
        pricePlaceholder: "249.90",
        priceError: "Enter a valid price",
        regularPriceLabel: "Full price total",
        regularPricePlaceholder: "299.90",
        regularPriceHelper: "Optional. Shows the original price before discount.",
        regularPriceError: "Enter a valid price",
        descriptionLabel: "Description",
        descriptionPlaceholder: "Add notes about what is included or how to redeem.",
        itemsLabel: "Included services",
        addItemLabel: "Add service",
        itemsEmptyError: "Add at least one service to the package.",
        itemsInvalidError: "Review the services and quantities before saving.",
        itemTitle: (index: number) => `Service ${index}`,
        itemServiceLabel: "Service",
        itemServicePlaceholder: "Select a service",
        itemServiceError: "Choose a service",
        itemQuantityLabel: "Quantity",
        itemQuantityPlaceholder: "1",
        itemQuantityError: "Enter a quantity greater than zero",
        pickerTitle: "Select a service",
        pickerSubtitle: "Choose which service belongs to this package.",
        pickerSearchPlaceholder: "Search services",
        pickerCloseLabel: "Close",
        pickerOptionMeta: (minutes: number, price: string) => `${minutes} min • ${price}`,
      },
      buttons: {
        create: "Save package",
        edit: "Save changes",
      ...
      accessibility: {
        ...
        removeItem: (index: number) => `Remove service ${index}`,
        openServicePicker: (index: number) => `Choose service for item ${index}`,
        selectService: (name: string) => `Select ${name}`,
        closePicker: "Close service list",
      },
      alerts: {
        ...
        createErrorTitle: "Create service package failed",
        updateErrorTitle: "Update service package failed",
      },
    },
    productForm: {
  ...
  pt: {
    ...
    servicePackageForm: {
      ...
      createSubtitle: "Monte combos de serviços com preço promocional.",
      editSubtitle: "Atualize o nome, os serviços inclusos ou o preço deste pacote.",
      fields: {
        nameLabel: "Nome",
        namePlaceholder: "10 cortes e barbas",
        nameError: "Nome é obrigatório",
        ...
        regularPricePlaceholder: "299,90",
        regularPriceHelper: "Opcional. Mostra o valor cheio para destacar o desconto.",
        regularPriceError: "Informe um valor válido",
        descriptionLabel: "Descrição",
        descriptionPlaceholder: "Detalhe o que está incluso ou regras de uso.",
        itemsLabel: "Serviços inclusos",
        addItemLabel: "Adicionar serviço",
        itemsEmptyError: "Inclua pelo menos um serviço no pacote.",
        itemsInvalidError: "Revise os serviços e quantidades antes de salvar.",
        itemTitle: (index: number) => `Serviço ${index}`,
        itemServiceLabel: "Serviço",
        itemServicePlaceholder: "Selecione um serviço",
        itemServiceError: "Escolha um serviço",
        itemQuantityLabel: "Quantidade",
        itemQuantityPlaceholder: "1",
        itemQuantityError: "Informe uma quantidade maior que zero",
        pickerTitle: "Selecionar serviço",
        pickerSubtitle: "Escolha qual serviço fará parte deste pacote.",
        pickerSearchPlaceholder: "Buscar serviços",
      ...
      accessibility: {
        ...
        removeItem: (index: number) => `Remover serviço ${index}`,
        openServicePicker: (index: number) => `Escolher serviço para o item ${index}`,
        selectService: (name: string) => `Selecionar ${name}`,
        closePicker: "Fechar lista de serviços",
      },
      alerts: {
